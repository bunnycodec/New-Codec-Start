...
const social_buttons_before = document.querySelector('.social-buttons a::before')
const social_buttons_hover = document.querySelector('.social-buttons a:hover i')
...
theme1.addEventListener('click', () => {
  ...
  social_buttons_before.style.backgroundImage = 'linear-gradient(225deg, #FF3CAC 0%, #784BA0 50%, #2B86C5 100%)'
  social_buttons_hover.style.backgroundImage = 'linear-gradient(225deg, #FF3CAC 0%, #784BA0 50%, #2B86C5 100%)'
})
...
theme2.addEventListener('click', () => {
  ...
  social_buttons_before.style.backgroundImage = 'linear-gradient(109.6deg, rgba(231, 120, 120, 1) 11.2%, rgba(246, 220, 111, 1) 91.2%)'
  social_buttons_hover.style.backgroundImage = 'linear-gradient(109.6deg, rgba(231, 120, 120, 1) 11.2%, rgba(246, 220, 111, 1) 91.2%)'
})
...
theme3.addEventListener('click', () => {
  ...
  social_buttons_before.style.backgroundImage = 'radial-gradient( circle farthest-corner at 10% 20%,  rgba(90,92,106,1) 0%, rgba(32,45,58,1) 81.3% )'
  social_buttons_hover.style.backgroundImage = 'radial-gradient( circle farthest-corner at 10% 20%,  rgba(90,92,106,1) 0%, rgba(32,45,58,1) 81.3% )'
})
